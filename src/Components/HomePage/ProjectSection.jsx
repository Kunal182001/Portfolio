...
import genproject from '../../assets/genproject.png';
        ...
        <div className='w-full  bg-[#09101A] flex justify-center pt-[130px]'>
            <div className='w-full md:w-[85%] flex flex-col items-center md:items-start mt-[400px] md:mt-0'>
                ...
                >
                    ...
                    >
                        <p className="text-xl md:text-2xl font-extrabold text-[#00bf63]">GenReels.ai</p>
                        <p className="text-[14px] md:text-[16px] text-[#FFFFFF] opacity-50 break-words mt-3">
                            Developed Genreels.ai, an AI-powered short-video generation platform using Next.js,
                             allowing users to create videos by selecting style, voice (male/female), and duration (30s/60s). 
                             Built a fully responsive user interface with dynamic form handling and seamless REST API integration,
                              while following a clean, component-based architecture to ensure scalability, maintainability, and optimal performance.
                        </p>
                    ...
                    {/* Icons (GitHub & Live Link) with Hover Pulse */}
                    <div className="w-[100px] h-[60px] absolute top-1 right-5 flex justify-center items-center gap-4">
                        <motion.a href='https://gen-reels-ai-kely.vercel.app/dashboard'
                            whileHover={{ scale: 1.3, y: -3, transition: { duration: 0.3 } }} 
                        >
                            <FaLink className="w-[40px] h-[40px] cursor-pointer text-[#00bf63]" />
                        </motion.a>
                        <motion.a href='https://github.com/Kunal182001/GenReels.AI'
                            whileHover={{ scale: 1.3, y: -3, transition: { duration: 0.3 } }} 
                        >
                            <FaGithub className="w-[40px] h-[40px] cursor-pointer text-[#00bf63]" />
                        </motion.a>
